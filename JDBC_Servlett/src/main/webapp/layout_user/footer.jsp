          ...
          <div class="row g-4">
            <div class="col-lg-3">
              <a href="#">
                ...
                <p class="text-secondary mb-0">Quần áo thời trang</p>
              </a>
            </div>
            <div class="col-lg-6">
              <div class="position-relative mx-auto">
                <input
                  ...
                  type="number"
                  placeholder="Nhập email của bạn để nhận được thông báo của chúng tôi"
                />
                <button
                  type="submit"
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-item">
              ...
              <img src="images/logo-2.jpg" class="img-fluid" alt="" />
            </div>
          </div>
        </div>
      </div>
