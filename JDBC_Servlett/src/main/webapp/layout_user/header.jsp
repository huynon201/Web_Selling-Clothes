        ...
        <div class="d-flex justify-content-between">
          <div class="top-info ps-2">
            <small class="me-3"
              ...
              <a href="#" class="text-white">275 phố Nhổn, Nam Từ Liêm, Hà Nội</a></small
            >
            <small class="me-3"
              ><i class="fas fa-envelope me-2 text-secondary"></i
              ><a href="#" class="text-white">Nhom18@gmail.com</a></small
            >
          </div>
      ...
      <div class="container px-0">
        <nav class="navbar navbar-light bg-white navbar-expand-xl">
          <a style="display: flex" href="index.html" class="navbar-brand"
            >
            <img style="heigh:50px; width: 50px; border-radius: 50%; margin-right: 20px" src="images/logo-2.jpg" class="img-fluid" alt="" />
          ...
          <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
            ...
            <div class="d-flex m-3 me-0">
			  ...
			  <span id="cartQuantity" class="position-absolute bg-secondary rounded-circle d-flex align-items-center justify-content-center text-dark px-1"
